...
@section('title', 'Help Desk | Add Training')
@section('content')
<div class="row">

	<div class="col-lg-12">
		<form action="{{ route('trainings.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
			@csrf
			
			<div class="card">
				<div class="card-header">
				    <strong>Add New</strong> Training
				</div>
				<div class="card-body card-block">
			        ...
			        <div class="row form-group">
			            ...
			            <div class="col-12 col-md-9">
			                <input type="text" name="provider" id="provider" class="form-control" placeholder="Name of the Organization">
			            </div>
			        </div>
					...
					<div class="row form-group">
			            ...
			            <div class="col-12 col-md-9">
			                <input type="text" name="location" id="location" class="form-control" placeholder="Where did you have this training">
			            </div>
			        </div>
					...
					<div class="row form-group">
			            ...
			            <div class="col-12 col-md-9">
			                <input type="text" name="extra" id="extra" class="form-control" placeholder="If No, where?">
			            </div>
			        </div>
				...
				<div class="card-footer">
				    <button type="submit" class="btn btn-primary btn-sm">
				        <i class="fa fa-dot-circle-o"></i> Create Record
				    </button>
