	    ...
	    <div class="card-header bg-white border-0">
	      <div class="row align-items-center">
	        ...
	        <div class="col-4 text-right">
	          <a href="{{ route('departments.index') }}" class="btn btn-sm btn-danger">Cancel Update</a>
	        </div>
	      </div>
	    </div>
	    <div class="card-body">
	          ...
	          <div class="row">
	            <div class="col-lg-5">
	              <div class="form-group">
	                ...
	                <input type="text" id="name" name="name" class="form-control form-control-alternative" value="{{ $department->name }}">
	              </div>
	            </div>
	            <div class="col-lg-5">
	              <div class="form-group">
	            ...
	            <div class="col-lg-2">
	              <div class="form-group">
	                ...
	                <input type="text" name="abv" id="abv" class="form-control form-control-alternative" value="{{ $department->abv }}">
	              </div>
	            </div>
	          </div>
	        </div>
