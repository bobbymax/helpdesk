...
// function actualPrice($total, $exchange_fee, $storage, $charges)
// {
//   $actual = $total - ($exchange_fee + $storage + $charges);
//   return $actual;
// }

// function basketTotal($exchange_fee, $farmties_charges, $subtotal)
// {
//   // calculate basket total
//   $vat = calculateVat($exchange_fee, $farmties_charges);
//   $total = $vat + $subtotal;
  
//   return $total;
// }

// function calculateVat($exchange_fee, $farmties_charges)
// {
//   // calculate VAT 5%
//   $vat = ($exchange_fee + $farmties_charges) * 0.05;
//   //return html_entity_decode("NGN " . number_format($vat));
//   return $vat;
// }
